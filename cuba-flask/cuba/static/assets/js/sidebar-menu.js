(function ($) {
  ...
  // $(document).ready(function() {
  //   var simplebarContentWrapper = $(".simplebar-wrapper .simplebar-content-wrapper");
  //   var pageWrapper = $("#pageWrapper");
  
  //   if (simplebarContentWrapper.length && pageWrapper.hasClass("compact-wrapper")) {
  //     var activeLink = simplebarContentWrapper.find("a.active");
  //     console.log('Simplebar Content Wrapper:', simplebarContentWrapper);
  //     console.log('Page Wrapper:', pageWrapper);
  //     console.log('Active Link:', activeLink);
  
  //     if (activeLink.length) {
  //       var offset = activeLink.offset();
  //       console.log('Active Link Offset:', offset);
  //       console.log('Active Link LENGTH LENGTH LENTHG:', activeLink.length);
  //       console.log('simplebarContentWrapper.length LENTHG:', simplebarContentWrapper.length);

  
  //       simplebarContentWrapper.animate(
  //         {
  ...
  //     }
  //   } else {
  //     console.log('Simplebar content wrapper or page wrapper not found');
  //   }
  // });
